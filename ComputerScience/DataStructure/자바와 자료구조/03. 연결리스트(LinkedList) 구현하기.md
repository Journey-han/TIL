...
- 자료가 추가될 때 노드만큼의 메모리를 할당받고 이전 노드의 링크로 연결한다.(정해진 크기가 있다.)
- 연결리스트의 i 번째 요소를 찾는게 걸리는 시간은 요소의 갯수에 비례 : O(n)
- JDK 클래스 : LinkedList
...
![Untitled](https://t1.daumcdn.net/cafeattach/1Dzpp/f819592e0ab0a07c5cd5e939d042f97bea5924e3)